...
export function SunburstIcon({ className = "w-5 h-5", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function ShieldCheckIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function KeyIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21 2-2 2m-1.5 1.5L14 9m0 0a5 5 0 1 0-7.07 7.07A5 5 0 0 0 14 9zm0 0 3 3 1.5-1.5 2 2 3.5-3.5" />
    </svg>
  );
}
...
export function ShareIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function ArrowDownIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function EditDocIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MoreHorizontalIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function InfoIcon({ className = "w-3.5 h-3.5", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function WarningIcon({ className = "w-4 h-4", size, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
